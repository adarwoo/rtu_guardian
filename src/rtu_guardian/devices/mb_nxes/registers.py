...
DEVICE_ESTOP_CAUSE_RELAY_FAULT = 1 << 1
DEVICE_ESTOP_CAUSE_MODBUS_COMMLOSS = 1 << 2
DEVICE_ESTOP_CAUSE_INFEED_POLARITY_INVERSION = 1 << 3
DEVICE_ESTOP_CAUSE_UNEXPECTED_VOLTAGE_TYPE = 1 << 4
DEVICE_ESTOP_CAUSE_UNDERVOLTAGE = 1 << 5
DEVICE_ESTOP_CAUSE_OVERVOLTAGE = 1 << 6
DEVICE_ESTOP_CAUSE_COMMAND = 1 << 7
DEVICE_ESTOP_CAUSE_APPLICATION_CRASH = 1 << 8
DEVICE_ESTOP_CAUSE_EEPROM_CORRUPTED = 1 << 9
DEVICE_ESTOP_CAUSE_SUPPLY_FAILURE = 1 << 11
