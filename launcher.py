...
def relaunch_in_terminal():
    ...
    if sys.platform == 'win32':
        ...
        wt_cmd = ['wt', '-w', '0', 'nt', '--title', 'rtu_guardian', exe_path] + args
        try:
...
if __name__ == '__main__':
    ...
    # Add src directory to path so we can import rtu_guardian
    ...
    import asyncio
    from rtu_guardian.__main__ import main, setup_debug
    setup_debug()
    asyncio.run(main())
